...
const matrixUtils = require("./matrixUtils/index");
...
L.Snow = L.Polygon.extend({
    ...
    onAdd: function (map) {
        ...
        map.addEventListener('move', this._reset, this);
        map.addEventListener('resize', this._resize, this);
    ...
    onRemove: function (map) {
        ...
        map.removeEventListener('moveend', this._reset, this);
    },
